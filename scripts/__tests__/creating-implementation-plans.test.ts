...
const SKILL_DIR = 'src/plugins/lwndev-sdlc/skills/creating-implementation-plans';
const SKILL_MD_PATH = join(SKILL_DIR, 'SKILL.md');
const TEMPLATE_PATH = join(SKILL_DIR, 'assets', 'implementation-plan.md');

describe('creating-implementation-plans skill', () => {
  let skillMd: string;
  let template: string;
  ...
  describe('SKILL.md', () => {
    it('should have frontmatter with name: creating-implementation-plans', () => {
      expect(skillMd).toMatch(/^---\s*\n[\s\S]*?name:\s*creating-implementation-plans[\s\S]*?---/);
    });
    ...
    it('should specify requirements/implementation/ as file location', () => {
  ...
  describe('implementation plan template', () => {
    it('should exist as assets/implementation-plan.md', () => {
